...
CREATE TABLE `detalles_afiliado` (
  ...
  KEY `detalles_afiliado_servicio_id_foreign` (`servicio_id`),
  ...
  CONSTRAINT `detalles_afiliado_servicio_id_foreign` FOREIGN KEY (`servicio_id`) REFERENCES `servicios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (14,'2025_02_16_024548_detalles_afiliado',1);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (15,'2025_02_17_010002_send_parentescos_after_migration',1);
