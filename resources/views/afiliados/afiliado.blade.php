                                    ...
                                    <div class="row">
                                        <div class="col-3 mb-2">
                                            ...
                                            <input type="text" placeholder="99.999.999" id="cedulaTitularAfiliado"
                                                inputmode="numeric" class="form-control searchInput cedula"
                                                id="CedulaTitular" name="CedulaTitular" required>
                                        ...
                                        <div class="col-3 mb-2">
                                            ...
                                            <select class="form-select" name="tipoServicio" id="tipoServicio">
                                                ...
                                                @foreach ($servicios as $servi)
                                                    <option value="{{ $servi->cantidad_maxima_beneficiarios }}">
                                                        {{ $servi->nombre }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-2 mb-3 mt-5">
                                                    ...
                                                    <input type="text" class="form-control cedula"
                                                        id="CedulaBeneficiario" inputmode="numeric"
                                                        placeholder="99.999.999" name="CedulaBeneficiario" required>
                                                </div>
                                                <div class="row">
                                                    <div class="col-3 mb-3 mt-2">
                                                        <label for="primer_nombre" class="form-label">Primer
                                                            Nombre</label>
                                                    ...
                                                    <div class="col-3 mb-3 mt-2">
                                                        <label for="segundo_nombre" class="form-label">Segundo
                                                            Nombre</label>
                                                        <input type="text" class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-3 mb-3">
                                                    ...
                                                    <input type="text" class="form-control telefono"
                                                        inputmode="numeric" placeholder="(412)-000-00-00"
